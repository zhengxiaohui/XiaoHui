...
public class WheelView extends View {
     ...
     * 单位的字体颜色
     */
    private int unitColor = 0xffff0000;
    /**
     * 蒙板高度
     */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        unitLeftMargin = (int) attribute.getDimension(R.styleable.WheelView_unitLeftMargin, unitLeftMargin);
        ...
        unitFont = attribute.getDimension(R.styleable.WheelView_unitTextSize, unitFont);
        ...
        unitColor = attribute.getColor(R.styleable.WheelView_unitTextColor, unitColor);
        ...
        unitText = attribute.getString(R.styleable.WheelView_unitText);
    ...
    public void refreshData(List<String> data) {
        int lastIndex = getSelectedId();//记住上一次的选中索引
        setData(data);
        setDefault(lastIndex);
        Message rMessage = new Message();
        rMessage.what = REFRESH_VIEW;
        handler.sendMessage(rMessage);
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas, int containerWidth) {
            ...
            unitTextPaint.setColor(unitColor);
            unitTextPaint.setTextSize(unitFont);
            if (isSelected() && !TextUtils.isEmpty(unitText)) {
                canvas.drawText(unitText, x + controlWidth / 2 - textRect.width() / 2 + textRect.width() + unitLeftMargin,
                        y + move + unitHeight / 2 + textRect.height() / 2, unitTextPaint);
            }
