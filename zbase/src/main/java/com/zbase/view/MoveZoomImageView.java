 ...
 * 移动，缩放图片
 */
public class MoveZoomImageView extends ImageView {
	...
	public MoveZoomImageView(Activity activity) {
		super(activity);
	...
	public void setMyImageBitmap(Bitmap bitmap){
		this.gintama=bitmap;
		Animation scaleAnimation = new ScaleAnimation(0.5f, 1f,0.5f,1f,Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,  
                0.5f);
		scaleAnimation.setDuration(500);
		this.startAnimation(scaleAnimation);
		matrix.setScale(2, 2);
		matrix.postTranslate(-bitmap.getWidth()/2, -bitmap.getHeight()/8);
		this.invalidate();
	}
