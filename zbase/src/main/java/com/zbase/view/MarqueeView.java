...
public class MarqueeView extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        ZLog.v(TAG, "onLayout called!" + "changed: " + changed);
    ...
    public void startMarquee() {
        ZLog.v(TAG, "startMarquee called");
    ...
    private void initView(Context context) {
        ...
        mTextField.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                ...
                ZLog.v(TAG, "afterTextChanged called");
...
//                    stringOfItem = str + interval;
                    ...
                    ZLog.v(TAG, "string of TextView deal ok!###");
                    ZLog.v(TAG, "lengthOfll: " + getMeasuredWidth() + "###");
                    ZLog.v(TAG, "lengthOfTextView: " + widthOfTextView
                            + "###");
                    ZLog.v(TAG, "CONTENT: " + stringOfTextView + "###");
                    // 设置起始
