...
public class HRecyclerViewPopupWindowAdapter extends ZBaseRecyclerAdapter<String> {


    public HRecyclerViewPopupWindowAdapter(Context context, boolean isHorizontal) {
