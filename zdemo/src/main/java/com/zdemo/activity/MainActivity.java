...
public class MainActivity extends BaseActivity implements OnItemClickListener {
    ...
    private Class[] classes = {AnimationActivity.class, HtmlTextActivity.class, PopupWinowActivity.class,
            ...
            LanguageSwitchActivity.class,DashBoardActivity.class,ProgressImageFrameLayoutActivity.class
    };
    private String[] demoNames = {"列表和图片的3D左右旋转", "HTML文本显示",
            ...
            ,"SwitchButton滑动开关","很少用到的系统控件使用示例","自定义注册和登录控件","切换语言环境","各种样式的表盘","带加载动画的图片控件（转圈圈）"
