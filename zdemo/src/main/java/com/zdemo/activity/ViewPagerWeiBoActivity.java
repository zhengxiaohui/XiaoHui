...
public class ViewPagerWeiBoActivity extends Activity {
    ...
    private void InitViewPager() {
        ...
        view3 = inflater.inflate(R.layout.viewpager_lay3, null);
        views.add(view1);
        views.add(view2);
        views.add(view3);
    ...
    public class MyOnPageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            Toast.makeText(ViewPagerWeiBoActivity.this, "您选择了" + viewPager.getCurrentItem() + "页卡", Toast.LENGTH_SHORT).show();
        }
